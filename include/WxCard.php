<?php
include_once("Wxcard/CardUtil.php");
/**
 * 微信卡包接口SDK
 ...
 * demo
 *      $wxcard = new WxCard("wxbb36d99200efa83a","XXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
		...
		//生成券
		//$ret = $wxcard->card_create(2, $base_info,$extra_data,"哈哈",1,100,"URL_NAME_TYPE_TAKE_AWAY","www.dodoca.com");
	    //s($ret);
	    //更新卡券
	    //$ret = $wxcard->card_update("p1fzRjvJljatuaLWLVFGax6EAHhQ",2,$base_info,array(1,strtotime("-1 days"),strtotime("+5 days")));
	    //s($ret);
	    //设置白名单
		//s($wxcard->card_testwhitelist_set_byusername(array("armycome"))); 
		
	   
 */
class WxCard extends CardUtil{
	// 接口网关地址
	...
	function __construct($uid = false, $access_token = true) {
		...
		if ($userinfo) {
			...
			// $this->access_token = "gaH4LmMmGn6cY619Uz84_l2muP5Ewo-GEw6v3rrJWWKjQnpkZNp2hGb0umma3ZJI1UBnNfy4XtWvjFNycbrp2j_Lb1ymRK9S_dbC97ezDmA";
		} else {
			return false;
		}
	}
     ...
     */
      ...
      * @return array
      */
     function card_create($merchant_type,$base_data,$extra_data,$location_id_list="",$sub_title="",$use_limit="",$get_limit="",$url_name_type="",$custom_url="",$source="",$can_share=true,$can_give_friend=true,$use_custom_code=false,$bind_openid=false){
     	//s($location_id_list);
        //exit();
        ...
        $base_info->set_custom_url($custom_url);
