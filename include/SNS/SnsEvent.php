...
class SnsEvent{
	...
	public function qq($token){
		$qq   = SnsOauth::getInstance('qq', $token);
	...
	public function tencent($token){
		//import("ORG.ThinkSDK.SnsOauth");
		$tencent = SnsOauth::getInstance('tencent', $token);
	...
	public function sina($token){
		$sina = SnsOauth::getInstance('sina', $token);
	...
	public function t163($token){
		$t163 = SnsOauth::getInstance('t163', $token);
	...
	public function renren($token){
		$renren = SnsOauth::getInstance('renren', $token);
	...
	public function x360($token){
		$x360 = SnsOauth::getInstance('x360', $token);
	...
	public function douban($token){
		$douban = SnsOauth::getInstance('douban', $token);
	...
	public function github($token){
		$github = SnsOauth::getInstance('github', $token);
	...
	public function google($token){
		$google = SnsOauth::getInstance('google', $token);
	...
	public function msn($token){
		$msn  = SnsOauth::getInstance('msn', $token);
		$data = $msn->call('me');
	...
	public function diandian($token){
		$diandian  = SnsOauth::getInstance('diandian', $token);
	...
	public function taobao($token){
		$taobao = SnsOauth::getInstance('taobao', $token);
	...
	public function baidu($token){
		$baidu = SnsOauth::getInstance('baidu', $token);
	...
	public function kaixin($token){
		$kaixin = SnsOauth::getInstance('kaixin', $token);
	...
	public function sohu($token){
		$sohu = SnsOauth::getInstance('sohu', $token);
