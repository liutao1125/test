...
//	正式环境API请求基础地址
	 ...
	 */
	public function __construct($account,$merchantPublicKey,$merchantPrivateKey,$yeepayPublicKey,$uid=''){
		...
		if(SYS_RELEASE==2){
			...
			$this->API_PC_Pay_Base_Url = 'https://ok.yeepay.com/payweb/';
		 	...
		 	if($uid == '3976'){ 
				...
				$this->API_Mobile_Pay_Base_Url = 'http://mobiletest.yeepay.com/testpayapi/mobile/';
